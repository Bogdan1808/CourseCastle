...
import { getOwnedCourses } from "@/app/actions/courseActions"
      ...
      <div className="relative z-10">
        ...
        <div className="bg-stone-900/90 text-white py-16 border-b border-stone-700">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl font-bold mb-6 text-amber-300 pixel-text">Your Owned Courses</h1>
            <p className="text-xl text-stone-300 mb-8 max-w-2xl">
              Continue your learning journey with the courses you own.
            </p>

            {/* Simple search for owned courses */}
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <input
                  type="text"
                  placeholder="Search your owned courses..."
                  value={searchTerm}
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold text-amber-300 pixel-text">
              Owned Courses ({filteredCourses.length})
            </h2>
          </div>

          {loading ? (
            <div className="flex justify-center items-center py-20">
              <div className="text-amber-300 text-xl">Loading your owned courses...</div>
            </div>
          ) : courses.length === 0 ? (
